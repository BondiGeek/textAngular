...
var htmlAttrs = makeMap('abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,'+
    ...
    'valign,value,vspace,width,layout,layout-xs,layout-gt-xs,layout-sm,layout-gt-sm,layout-md,layout-gt-md,layout-lg,layout-gt-lg,layout-xl,flex,flex-order,flex-order-xs,flex-order-gt-xs,flex-order-sm,flex-order-gt-sm,flex-order-md,flex-order-gt-md,flex-order-lg,flex-order-gt-lg,flex-order-xl,flex-offset,flex-offset-xs,flex-offset-gt-xs,flex-offset-sm,flex-offset-gt-sm,flex-offset-md,flex-offset-gt-md,flex-offset-lg,flex-offset-gt-lg,flex-offset-xl,layout-align,layout-align-xs,layout-align-gt-xs,layout-align-sm,layout-align-gt-sm,layout-align-md,layout-align-gt-md,layout-align-lg,layout-align-gt-lg,layout-align-xl,hide-xsshow-xs,hide-gt-xs,hide-sm,hide-gt-sm,hide-md,hide-gt-md,hide-lgshow-lg,hide-gt-lg,hide-xl');
